              ...
              <div class="card-body text-center">
                ...
                <p>
                  ...
                  <?php if ($umPerfil['instagram'] != "") { ?>
                    <a href="<?= $umPerfil['instagram']; ?>" class="btn btn-outline-dark"><i class="bi bi-instagram"></i></a>
                  <?php } ?>

                  <?php if ($umPerfil['twitter'] != "") { ?>
                    <a href="<?= $umPerfil['twitter']; ?>" class="btn btn-outline-dark"><i class="bi bi-twitter-x"></i></a>
                  <?php } ?>

                  <?php if ($umPerfil['facebook'] != "") { ?>
                    <a href="<?= $umPerfil['facebook']; ?>" class="btn btn-outline-primary"><i class="bi bi-facebook"></i></a>
                  <?php } ?>

                  <?php if ($umPerfil['linkedin'] != "") { ?>
                    <a href="<?= $umPerfil['linkedin']; ?>" class="btn btn-outline-info"><i class="bi bi-linkedin"></i></a>
                  <?php } ?>

                  <?php if ($umPerfil['youtube'] != "") { ?>
                    <a href="<?= $umPerfil['youtube']; ?>" class="btn btn-outline-danger"><i class="bi bi-youtube"></i></a>
                  <?php } ?>
